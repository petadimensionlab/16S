...
## softwares ##
vsearch = '/Users/snakaoka/Dropbox/research/metagenome/vsearch/bin/vsearch'
fastqc = '/Users/snakaoka/Dropbox/research/metagenome/FastQC/fastqc'
Trimmomatic = '/Users/snakaoka/Dropbox/research/metagenome/Trimmomatic/trimmomatic-0.36.jar'
mothur = '/Users/snakaoka/Dropbox/research/metagenome/mothur/mothur'

## input / output file ##
input_dir = '/Users/snakaoka/Desktop/PRJNA322188'
output_dir = '/Users/snakaoka/Desktop/PRJNA322188'
...
# Silva #
silva_fasta = '/Users/snakaoka/ws/ref/silva_104/silva_104_rep_set.fasta'
silva_tax = '/Users/snakaoka/ws/ref/silva_104/Silva_taxa_mapping_104set_97_otus.txt'
# RDP #
...
header = { 'gg':'gg_','silva':'silva_','rdp':'rdp_' }
...
if is_append=='yes':
    if is_pairend=='yes':
        ...
        with open(appended_file,'wb') as output_handle:
...
if is_deletefiles=='yes':
    ...
    merged_files = glob.glob('*_trimmed.fasta')
